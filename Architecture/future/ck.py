...
class UserRegistrationApp:
    def __init__(self, root):
        ...
        self.faceCascade = cv2.CascadeClassifier('/home/abdisa/Desktop/facial_analysis/Assets/haarcascade_frontalface_default.xml')
        ...
        self.conn = sqlite3.connect(r'DataBase/user_database.db')
        self.c = conn.cursor()
    ...
    def capture_image(self):
        ...
        if ret and len(self.captured_images) < 5:
            ...
            messagebox.showinfo("Capture", f"Captured image {len(self.captured_images)} of 5")
